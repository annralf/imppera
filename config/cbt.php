...
class CBT {
	...
	public $redirect_uri = "https://core.enkargo/enkargo/config/cbt_token";
	...
	public function __inicializar($code = null) {
		...
		if (!$code) {
			header("Location:https://cbt.mercadolibre.com/merchant/authorization/?client_id=".$this->client_id."&response_type=code&redirect_uri=https://core.enkargo/enkargo/config/cbt_token.php");
			exit;
		}
