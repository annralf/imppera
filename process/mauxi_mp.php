...
$sql="select id,id_payments from system.orders where shop_id=2 and id not in (select id_order from system.mp);";
...
$sql2="select o.id_payments,mp.id,mp.status from system.orders o join system.mp mp on o.id=mp.id_order where o.shop_id=2 and mp.date_created > (CURRENT_DATE - INTERVAL '15 days');";
